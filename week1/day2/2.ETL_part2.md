...
We saw in the first lesson we can fitler simply with the following:
...
Now we will look at more involved data transformation methods, namely aggregations, merging, and filtering. We will demonstrate how to:
