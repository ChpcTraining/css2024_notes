...
There is a something to consider here is that if you don't know your data is in the wrong format or messy, then some of what you will learn now might not make sense. For example, someone might see your table is messy full of books and they recommend you tidy it up so you can work better. And you say, well its not messy at all I work just fine. Fine maybe, but maybe not as efficient and effective as possible. So, what I am saying is, if you your use cleaning your data in Excel or other tools then this should be quite familiar to you. Now we are just using Python to do it.
