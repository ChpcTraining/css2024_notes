...
Another consideration is that dates are usually interpreted as strings or text in a csv file. So the first thing you need to do is convert it to date format using Pandas.
