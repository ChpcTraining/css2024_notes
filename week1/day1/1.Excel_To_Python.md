...
Download the csv file called "country_data.csv" found in the "Week 1 - Day 1" section on Canvas
...
Now let us add one more useful line of code:
...
This is a really useful feature of Pandas as it summarizes for you table. Amount of columns, their names, Non-Null Count, and the Dtype or data type. **The last one is an important one to consider as many times when you are reading in date, numbers or dates are read in as text or strings. Which prevents you from doing an approporiate filtering, sorting or numerical analysis **. In this is was read in correctly:

- int64: integer or whole numbers
- object: text or strings

Now use pandas and read in these files like we did above and run the .info() method. You can find the files in "Week 1" section:
