...
`import pandas as pd`: This line imports the pandas library and gives it the alias 'pd' for easier reference in the code. 
...
Now try out the other csv files found in: "Week 1 - Day 1"
