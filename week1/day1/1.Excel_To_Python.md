...
Now try out the other files found in: "Week 1":
- iris.csv
- diab_data.csv
- housing_data.csv
- auto_insurance_data.txt

Do you find anything wrong with them?

_Upload some of your own data files to the `#chat` channel in slack_
...
__ Start thinking of how you can use your own data in Python __
